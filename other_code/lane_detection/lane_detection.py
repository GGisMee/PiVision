...
if __name__ == "__main__":
    ...
    input_video = 'runtime/python/lane_detection/input_video.mp4'
    hef_path = 'runtime/python/lane_detection/ufld_v2.hef'
    try:
        original_frame_width,original_frame_height, total_frames= get_video_info(input_video)
